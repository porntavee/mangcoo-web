...
@Component({
  selector: 'goodsshop-card',
  templateUrl: './goodsshop-card.component.html',
  styleUrls: ['./goodsshop-card.component.css']
})
export class GoodsShopCardComponent implements OnInit {
