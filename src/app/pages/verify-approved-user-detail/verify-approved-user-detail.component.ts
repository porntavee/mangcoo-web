...
@Component({
  selector: 'app-verify-approved-user-detail',
  templateUrl: './verify-approved-user-detail.component.html',
  styleUrls: ['./verify-approved-user-detail.component.css']
})
export class VerifyApprovedUserDetailComponent implements OnInit {
  code: string = '';
  model: any = [];
  modelFile: any = [];
  modelVdo: any = [];
  ...
  ngOnInit(): void {
    ...
    this.callReadVerifyApprovedUser();
    this.galleryFileRead();
  }

  callReadVerifyApprovedUser() {
    this.serviceProviderService.post('m/verifyApprovedUser/read', { "code": this.code }).subscribe(response => {
  ...
  galleryFileRead() {
    this.serviceProviderService.post('m/verifyApprovedUser/galleryFile/read', { code: this.code }).subscribe(data => {
      let modef: any = {};
      modef = data;
  ...
  navBack() {
    this.router.navigate(['/verify-approved-user']);
  }
  ...
  shareWithFB() {
    var url = this.serviceProviderService.urlweb + "verify-approved-user-detail/" + this.modelDetail.code;
