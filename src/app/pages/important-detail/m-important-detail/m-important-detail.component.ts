...
@Component({
  selector: 'app-m-important-detail',
  templateUrl: './m-important-detail.component.html',
  styleUrls: ['./m-important-detail.component.css']
})
export class MImportantDetailComponent implements OnInit {
  code: string = '';
  model: any = {};
  modelOther: any = [];
  ...
  read() {
    this.spinner.show()
    this.serviceProviderService.post('important/read', { code: this.code }).subscribe(response => {
      let data: any = [];
      data = response;
