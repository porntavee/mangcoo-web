...
@Component({
  selector: 'app-m-news-detail',
  templateUrl: './m-news-detail.component.html',
  styleUrls: ['./m-news-detail.component.css']
})
export class MNewsDetailComponent implements OnInit {
  code: string = '';
  model: any = {};
  modelOther: any = [];
