...
@Component({
  selector: 'app-d-event-abroad-detail',
  templateUrl: './d-event-abroad-detail.component.html',
  styleUrls: ['./d-event-abroad-detail.component.css']
})
export class DEventAbroadDetailComponent implements OnInit {
  code: string = '';
  model: any = {};
  modelFile: any = [];
  modelVdo: any = [];
  ...
  read() {
    this.spinner.show()
    this.serviceProviderService.post('m/eventAbroad/read', { code: this.code }).subscribe(response => {
      let data: any = [];
      data = response;
  ...
  galleryRead() {
    this.serviceProviderService.post('m/eventAbroad/gallery/read', { code: this.code }).subscribe(data => {
      let model: any = {};
      this.model.gallery = [];
      model = data;
  ...
  galleryFileRead() {
    this.serviceProviderService.post('m/eventAbroad/galleryFile/read', { code: this.code }).subscribe(data => {
      let modef: any = {};
      modef = data;
