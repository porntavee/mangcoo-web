...
@Component({
  selector: 'app-d-important',
  templateUrl: './d-important.component.html',
  styleUrls: ['./d-important.component.css']
})
export class DImportantComponent implements OnInit {
  model: any = [];
  ...
  read() {
    this.serviceProviderService.SendIPAddress("Important");
