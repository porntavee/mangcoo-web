...
@Component({
  selector: 'app-d-knowledge-detail',
  templateUrl: './d-knowledge-detail.component.html',
  styleUrls: ['./d-knowledge-detail.component.css']
})
export class DKnowledgeDetailComponent implements OnInit {
  code: string = '';
  model: any = [];
  modelFile: any = [];
  modelVdo: any = [];
  ...
  callReadKnowledge() {
    this.serviceProviderService.post('m/knowledge/read', { "code": this.code }).subscribe(response => {
  ...
  galleryFileRead() {
    this.serviceProviderService.post('m/knowledge/galleryFile/read', { code: this.code }).subscribe(data => {
      let modef: any = {};
      modef = data;
  ...
  shareWithFB() {
    var url = this.serviceProviderService.urlweb + "knowledge-detail/" + this.modelDetail.code;
